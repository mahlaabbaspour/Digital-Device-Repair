              ...
              <ClickAwayListener onClickAway={e => handleDropdownClose(e as MouseEvent | TouchEvent)}>
                <MenuList>
                  <div
                    ...
                    tabIndex={-1}
                    onClick={e => handleDropdownClose(e, `/institution/${id}/base/profile`)}
                  >
                    <Avatar alt={session?.user?.user?.first_name || ''} src={session?.user?.image || ''} />
                    <div className='flex items-start flex-col ' style={{ maxWidth: '12rem' }}>
                      ...
                      <Typography className=' cursor-pointer ' variant='caption' sx={{ wordBreak: 'break-word' }}>
                        {`${session?.user?.user?.first_name} ${session?.user?.user?.last_name}(${session?.user?.user?.username})`}
                      </Typography>
                    </div>
                  </div>
                  <Divider></Divider>
                  <div className='px-[12px] py-[8px]'>
                    ...
                    <Button
                      ...
                      href={`/user/${id}/cartable/dashboard`}
                      fullWidth
                      color='inherit'
                      sx={{
                        textAlign: 'right',
                    ...
                    <Button
                      ...
                      href={`/superUser/${id}/cartable/dashboard`}
                      fullWidth
                      color='inherit'
                      sx={{
                        textAlign: 'right',
...
export default UserDropdownInstitution
