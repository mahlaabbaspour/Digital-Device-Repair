...
import { useCreateTargetOrganization } from '@/hooks/admin/base/useTargetOrganization'
...
export default function ModalLCreateTargetOrganization({
  onClose,
  open,
  title,
  description
  ...
  const { mutateAsync, isPending }: any = useCreateTargetOrganization()
