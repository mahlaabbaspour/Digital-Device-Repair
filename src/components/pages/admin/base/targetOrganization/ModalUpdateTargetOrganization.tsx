...
import { useUpdateTargetOrganization } from '@/hooks/admin/base/useTargetOrganization'
...
export default function ModalUpdateTargetOrganization({
  onClose,
  open,
  title,
  description,
  ...
  const { mutateAsync, isPending }: any = useUpdateTargetOrganization()
