...
import { useUpdateCitizenship } from '@/hooks/admin/base/useCitizenship'
...
export default function ModalUpdateCitizenship({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateCitizenship();
