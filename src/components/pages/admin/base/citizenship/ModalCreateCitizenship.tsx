...
import { useCreateCitizenship } from '@/hooks/admin/base/useCitizenship'
...
export default function ModalCreateCitizenship({ onClose, open , title, description }: {  onClose: any, open: boolean , title: string , description : string }) {
  ...
  const { mutateAsync , isPending } : any = useCreateCitizenship();
