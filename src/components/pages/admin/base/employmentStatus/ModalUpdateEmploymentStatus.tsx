...
import { useUpdateEmploymentStatus } from '@/hooks/admin/base/useEmploymentStatus'
...
export default function ModalUpdateEmploymentStatus({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateEmploymentStatus();
