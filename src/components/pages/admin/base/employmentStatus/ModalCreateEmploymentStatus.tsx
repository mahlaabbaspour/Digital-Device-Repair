...
import { useCreateEmploymentStatus } from '@/hooks/admin/base/useEmploymentStatus'
...
export default function ModalCreateEmploymentStatus({ onClose, open , title, description }: {  onClose: any, open: boolean , title: string , description : string }) {
  ...
  const { mutateAsync , isPending } : any = useCreateEmploymentStatus();
