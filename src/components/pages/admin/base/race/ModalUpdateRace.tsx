...
import { useUpdateRace } from '@/hooks/admin/base/useRace'
...
export default function ModalUpdateRace({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateRace();
