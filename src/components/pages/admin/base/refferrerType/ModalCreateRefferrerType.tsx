...
import { useCreateRefferrerType } from '@/hooks/admin/base/useRefferrerType'
...
export default function ModalLCreateRefferrerType({ onClose, open , title, description }: {  onClose: any, open: boolean , title: string , description : string }) {
  ...
  const { mutateAsync , isPending } : any = useCreateRefferrerType();
