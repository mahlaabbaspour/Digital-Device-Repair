...
import { useUpdateMarital } from '@/hooks/admin/base/useMarital'
...
export default function ModalUpdateMarital({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateMarital();
