...
import { useCreateMarital } from '@/hooks/admin/base/useMarital'
...
export default function ModalCreateMarital({ onClose, open , title, description }: {  onClose: any, open: boolean , title: string , description : string }) {
  ...
  const { mutateAsync , isPending } : any = useCreateMarital();
