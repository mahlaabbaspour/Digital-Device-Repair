...
export default function MaritalTable() {
  ...
  return (
    <>
      <ModalCreateMarital
        title='ایجاد وضعیت تاهل'
        description='می توانید وضعیت تاهل مورد نظر را ایجاد کنید'
      ...
      <ModalUpdateMarital
        ...
        title={`${action === 'edit' ? 'ویرایش وضعیت تاهل' : 'نمایش  وضعیت تاهل'}`}
        description={`${action === 'edit' ? 'می توانید وضعیت تاهل مورد نظر را ویرایش کنید' : 'می توانید وضعیت تاهل مورد نظر را مشاهده کنید'}`}
        open={modalOpen}
