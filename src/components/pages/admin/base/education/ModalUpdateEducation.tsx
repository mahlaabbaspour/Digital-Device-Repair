...
export default function ModalUpdateEducation({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
