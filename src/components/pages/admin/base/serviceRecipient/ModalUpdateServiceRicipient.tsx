...
export default function ModalUpdateServiceRecipient({ action , currentRow, onClose, open , title, description }: { action: any , currentRow: any,  onClose: any, open: boolean , title: string , description : string }) {


  console.log(action, currentRow, 'test')
