...
import { useCreateLanguage } from '@/hooks/admin/base/useLanguage'
...
export default function ModalLCreateLanguage({ onClose, open , title, description }: {  onClose: any, open: boolean , title: string , description : string }) {
  ...
  const { mutateAsync , isPending } : any = useCreateLanguage();
