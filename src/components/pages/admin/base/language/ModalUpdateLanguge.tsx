...
import { useUpdateLanguage } from '@/hooks/admin/base/useLanguage'
...
export default function ModalUpdateLanguage({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateLanguage();
