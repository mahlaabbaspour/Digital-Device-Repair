...
export default function NationalityTable() {
  ...
  return (
    <>
      <ModalLCreateNationality
        title='ایجاد ملیت'
        description='می توانید ملیت مورد نظر را ایجاد کنید'
        open={modalOpenCreate}
        onClose={() => setModalOpenCreate(false)}
      />
      <ModalUpdateNationality
        action={action}
        currentRow={currentRow}
        title={`${action === 'edit' ? 'ویرایش ملیت' : 'نمایش ملیت'}`}
        description={`${action === 'edit' ? 'می توانید ملیت مورد نظر را ویرایش کنید' : 'می توانید ملیت مورد نظر را مشاهده کنید'}`}
        open={modalOpen}
