...
import { useUpdateNationality } from '@/hooks/admin/base/useNationality'
...
export default function ModalUpdateNationality({ onClose, open , title, description , action , currentRow }: { currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateNationality();
