...
import { useCreateNationality } from '@/hooks/admin/base/useNationality'
...
export default function ModalLCreateNationality({ onClose, open , title, description }: {  onClose: any, open: boolean , title: string , description : string }) {
  ...
  const { mutateAsync , isPending } : any = useCreateNationality();
