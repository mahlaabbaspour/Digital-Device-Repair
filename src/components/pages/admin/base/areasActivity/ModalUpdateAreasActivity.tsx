...
import { useUpdateAreasActivity } from '@/hooks/admin/base/useAreasActivity'
...
export default function ModalUpdateAreasActivity({
  onClose,
  open,
  title,
  description,
  ...
  const { mutateAsync, isPending }: any = useUpdateAreasActivity()
