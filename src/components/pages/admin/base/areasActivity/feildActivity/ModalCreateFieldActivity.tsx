...
import { useCreateFieldActivity } from '@/hooks/admin/base/useFieldActivity'
...
export default function ModalCreateFieldActivity({
  id,
  onClose,
  open,
  title,
  ...
  const { mutateAsync, isPending }: any = useCreateFieldActivity()
