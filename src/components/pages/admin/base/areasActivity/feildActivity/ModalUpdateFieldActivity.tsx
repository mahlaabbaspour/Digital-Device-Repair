...
import { useUpdateFieldActivity } from '@/hooks/admin/base/useFieldActivity'
...
export default function ModalUpdateFieldActivity({ id,  onClose, open , title, description , action , currentRow }: { id: any, currentRow: any, action: any, onClose: any, open: boolean , title: string , description : string }) {
  ...
  useEffect(() => {
    ...
    const { mutateAsync , isPending } : any = useUpdateFieldActivity();

  async function onSubmit(values: any) {
       try {
         await toast.promise(mutateAsync({data: values, id: id , rowId: rowId}) , {
