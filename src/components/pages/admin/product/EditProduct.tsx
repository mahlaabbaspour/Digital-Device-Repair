...
import { useGetProduct, useUpdateProduct } from '@/hooks/admin/product/useProduct'
...
export default function ProductEdit({ open, id, onClose }: Props) {
  ...
  useEffect(() => {
    if (productData) {
      reset({
        ...
        sale_price: productData.data.sale_price,
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            <DialogTitle sx={{ p: 0, fontSize: '1.2rem', fontWeight: 700 }}>ویرایش کالا</DialogTitle>
