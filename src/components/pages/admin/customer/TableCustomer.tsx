...
import CustomerShow from './ShowCustomer'
...
export default function CustomerTable() {
  ...
  const items = [{ title: 'داشبورد', to: '/admin' }, { title: 'مشتریان' }]
  ...
  return (
    <>
      ...
      <CustomTable
        titleTable={{
          title: 'فهرست مشتریان',
          description: 'تمام مشتریان ثبت شده'
        }}
      ...
      />
      <CustomerShow open={!!showId} id={showId} onClose={() => setShowId(null)} />
      <CustomerEdit open={!!editId} id={editId} onClose={() => setEditId(null)} />
    </>
  )
}
