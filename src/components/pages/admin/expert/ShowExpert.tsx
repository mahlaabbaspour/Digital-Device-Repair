...
import { useGetExpert } from '@/hooks/admin/expert/useExpert'
...
export default function ExpertShow({ open, id, onClose }: Props) {
  const { data, isLoading, isError } = useGetExpert(id)
          ...
          <Box>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <InfoItem icon='mdi:package-variant-closed' label='نام کارشناس' value={expert.first_name} />
              </Grid>
