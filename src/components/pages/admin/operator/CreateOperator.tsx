...
import { useCreateOperator } from '@/hooks/admin/operator/useOperator'
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            <DialogTitle sx={{ p: 0, fontSize: '1.2rem', fontWeight: 700 }}>ایجاد اپراتور</DialogTitle>

            <Typography variant='body2' color='text.secondary' sx={{ mt: 0.5 }}>
              اطلاعات اپراتور را وارد کنید
            </Typography>
          </Box>
        </Box>
      </Box>
