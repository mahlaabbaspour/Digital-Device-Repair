...
const DEFAULT_IMAGE = '/images/avatars/1.png'
// Vars
const steps = [
  {
    title: 'اطلاعات پایه ',
        ...
        return (
          <Grid container spacing={4} my={2}>
            ...
            <Grid item xs={12} sx={{ display: 'flex' }}>
              <Image className='rounded-sm' src={ImageSrc} alt='تصویر کاربر' width={120} height={120} />
              {!disabled && (
                <Box display='grid' gap='1rem' alignContent='end' ml='1rem'>
                  <div>
                    <ButtonStyled
                      component='label'
                      variant='contained'
                  ...
                  <Typography variant='caption'>پسوند فایل انتخاب شده باید jpg یا png باشد</Typography>
                </Box>
              )}
            </Grid>
            {/* first_name */}
