...
const dataStruct = {
  ...
  customCol: [
    ...
    return (
        <>
        <CreateExternalStorage action={action} currentRow={currentRow} id={id} open={openModal1} setOpen={setOpenModal1} disabled={false} title='ایجاد حافظه خارجی' description='اطلاعات حافظه خارجی را وارد کنید' />
        <CreateSMSServer action={action} currentRow={currentRow} id={id} open={openModal2} setOpen={setOpenModal2} disabled={false} title='ایجاد سرویس پیامک' description='اطلاعات سرویس پیامک را وارد کنید' />
        <CreateClassOnlineServer action={action} currentRow={currentRow} id={id} open={openModal3} setOpen={setOpenModal3} disabled={false} title='ایجاد کلاس آنلاین' description='اطلاعات کلاس آنلاین را وارد کنید' />
        <CustomTable
