...
import {
  useCreateCalenderGroupConsultation,
  useCreateCheckClanderGroupConsultation
...
export default function ModalGroupMeeting({
  ...
  const { mutateAsync, isPending }: any = useCreateCheckClanderGroupConsultation()
  const { mutateAsync: create, isPending: loading }: any = useCreateCalenderGroupConsultation()
