...
import { useUpdateChapterCourseInstitution } from '@/hooks/institution/education/useLessonEducation'
import { CloseRounded } from '@mui/icons-material'
import { useEffect } from 'react'

export default function UpdateChaptersModal({
  onClose,
  open,
  id,
  courseId,
  ...
  useEffect(() => {
    if (rowSelect) {
      setValue('title', rowSelect?.title)
    }
  }, [rowSelect])

  const { mutateAsync, isPending }: any = useUpdateChapterCourseInstitution()
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogContent sx={{ pb: 6, px: { xs: 8, sm: 15 }, pt: { xs: 8, sm: 12.5 }, position: 'relative' }}>
            ...
            <CardHeader
              ...
              subheader={<Typography variant='caption'>می توانید سرفصل آموزشی را ویرایش کنید</Typography>}
            />
            <CardContent>
