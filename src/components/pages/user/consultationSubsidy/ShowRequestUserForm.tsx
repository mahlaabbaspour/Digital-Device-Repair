...
import TableConsultationVouchers from '../../institution/consultationSubsidy/TableConsultationVouchers'

export default function CardRequestShowUser({ data, show, id }: any) {
