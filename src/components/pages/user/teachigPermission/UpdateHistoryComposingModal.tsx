...
import { useUpdateHistoryComposingTeachingPermission } from '@/hooks/user/useTeachigPermission'
import { toast } from 'react-toastify'
import { dateConverter } from '@/helpers/DateHelpers'
import { useEffect } from 'react'

export default function UpdateHistoryComposingModal({
  onClose,
  open,
  id,
  teachId,
  ...
  const { mutateAsync, isPending }: any = useUpdateHistoryComposingTeachingPermission()
