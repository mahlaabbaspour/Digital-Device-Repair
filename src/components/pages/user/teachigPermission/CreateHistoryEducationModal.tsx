...
import { useCreateHistoryEducationTeachingPermission } from '@/hooks/user/useTeachigPermission'
...
export default function CreateHistoryEducationModal({
  onClose,
  open,
  id,
  teachId,
  ...
  const { mutateAsync, isPending }: any = useCreateHistoryEducationTeachingPermission()
