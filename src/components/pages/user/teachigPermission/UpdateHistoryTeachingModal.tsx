...
import { useUpdateHistoryTeachingTeachingPermission } from '@/hooks/user/useTeachigPermission'
...
export default function UpdateHistoryTeachingModal({
  onClose,
  open,
  id,
  teachId,
  ...
  const { mutateAsync, isPending }: any = useUpdateHistoryTeachingTeachingPermission()
