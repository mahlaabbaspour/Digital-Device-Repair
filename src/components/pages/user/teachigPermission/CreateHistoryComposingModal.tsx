...
import { useCreateHistoryComposingTeachingPermission } from '@/hooks/user/useTeachigPermission'
import { toast } from 'react-toastify'
import { dateConverter } from '@/helpers/DateHelpers'

export default function CreateHistoryComposingModal({
  onClose,
  open,
  id,
  teachId,
  ...
  const { mutateAsync, isPending }: any = useCreateHistoryComposingTeachingPermission()
