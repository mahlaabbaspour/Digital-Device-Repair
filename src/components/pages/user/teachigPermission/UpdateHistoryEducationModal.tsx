...
import { useUpdateHistoryEducationTeachingPermission } from '@/hooks/user/useTeachigPermission'
...
export default function UpdateHistoryEducationModal({
  onClose,
  open,
  id,
  teachId,
  ...
  const { mutateAsync, isPending }: any = useUpdateHistoryEducationTeachingPermission()
