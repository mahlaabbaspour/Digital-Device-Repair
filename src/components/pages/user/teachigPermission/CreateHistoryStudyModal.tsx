...
import { useCreateHistoryStudyTeachingPermission } from '@/hooks/user/useTeachigPermission'
import { toast } from 'react-toastify'

export default function CreateHistoryStudyModal({
  onClose,
  open,
  id,
  teachId,
  ...
  const { mutateAsync, isPending }: any = useCreateHistoryStudyTeachingPermission()
