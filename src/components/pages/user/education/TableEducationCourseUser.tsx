...
const dataStruct = {
  title: ['عنوان دوره', 'هزینه دوره', , 'زمان شروع و پایان دوره', 'وضعیت'],
  name: [['title'], ['course_fee'], ['course_start_at', 'course_end_at'], ['courseStatus']],
...
export default function TableEducationalCourseUser({ id }: any) {
  ...
  return (
    <>
      ...
      <CustomTable
        baseUrl={`/user/${id}/education/course/core/course/`}
