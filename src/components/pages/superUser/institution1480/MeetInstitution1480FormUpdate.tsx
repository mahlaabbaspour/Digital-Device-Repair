...
import { useUpdateMeetingAndDiagnosisInstitution } from '@/hooks/superUser/useInstitution1480'
...
export default function UpdateMeetInstitution1480Form({ id, upsertData, meetingId, disabled, show }: any) {
  ...
  useEffect(() => {
    if (show) {
      ...
      setValue('institution_id', show?.institution ? show?.institution : undefined)
  ...
  const { mutateAsync, isPending }: any = useUpdateMeetingAndDiagnosisInstitution()
