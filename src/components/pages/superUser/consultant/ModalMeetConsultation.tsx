...
export default function ModalMeetConsultation({
  onClose,
  open,
  title,
  description,
  ...
  useEffect(() => {
    if (selectedEvent) {
      ...
      setValue('institution_id', selectedEvent?.institution)
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <DialogActions>
            ...
            {selectedEvent?.consultationDocument && (
              <Button
                variant='contained'
                ...
                onClick={() =>
                  router.push(
                    `/superUser/${id}/consultant/consultantDocument/${selectedEvent?.consultationDocument?.id}/diagnosis`
                  )
                }
              >
                تشخیص های مشاور
