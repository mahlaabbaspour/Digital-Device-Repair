...
import CustomRadioIconsInstution from '@/components/pages/institution/consultationDocuments/documentList/CustomRadioIconsInstutition'

export default function CardShowDocumentAndDiagnosisConsultation({ id, documentId, show }: any) {
