...
export default function ConfirmForm({ id, revisionId, upsertData = [], show }: any) {
  ...
  useEffect(() => {
    if (show) {
      setValue('objection', show?.objection)
      setValue('request_teaching_permission_status_id', show?.requestTeachingPermissionStatus?.id)
    }
  }, [show])
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          ...
                          >
                            ...
                            <FormControlLabel
                              value={2}
                              control={<Radio sx={{ display: 'none' }} readOnly={true} />}
                              label={
                                <Box
                                  sx={{
                                    px: 4,
