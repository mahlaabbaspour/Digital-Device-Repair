...
import { useChangeDocumentConsultant } from '@/hooks/superUser/useDiagnosis'

export default function ChangeStatusDocumentConsultant({
  onClose,
  open,
  id,
  selectedRow
  ...
  const { mutateAsync, isPending }: any = useChangeDocumentConsultant()
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, value }, fieldState: { error } }) => (
                        <CustomAsyncAutocomplete
                          url={`/super-user/${id}/base/select/institution/?institution_id=${selectedRow?.institution?.id}`}
                          readOnly={false}
